//Create a 2 classes , Runner and Televison ->10  states and 5 behaviours , use static variables for states and static methods for behaviours 
, use static block to initialize all static variables -> create 5 objects for Televison  
